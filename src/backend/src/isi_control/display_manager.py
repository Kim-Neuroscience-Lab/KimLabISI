...
from .hardware_utils import (
    HardwareDevice, HardwareDetector,
    parse_system_profiler_displays, estimate_device_capabilities,
    create_ipc_handler
)
    ...
    def _detect_displays_macos(self) -> List[DisplayInfo]:
        ...
        try:
            ...
            for data in display_data:
                ...
                logger.info(f"Detected display: {display_info.name} ({display_info.width}x{display_info.height} @ {display_info.refresh_rate}Hz)")
