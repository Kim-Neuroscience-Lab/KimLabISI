...
class PreviewModeController(AcquisitionModeController):
    ...
    def activate(
        ...
        **kwargs
        ...
        frame_id = shared_memory_service.write_preview_frame(frame, preview_metadata)
        frame_info = shared_memory_service.get_frame_info(frame_id)
